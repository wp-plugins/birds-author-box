...
class Birds_Authorbox_Main {
    ...
    public function register_admin_scripts() {
        //wp_enqueue_media();
        //wp_enqueue_script( 'birds-media', plugins_url( '/birds-author-box/admin/js/media.js' ), array( 'jquery', 'jquery-ui-sortable' ), null, true );
    ...
    private function run_plugin() {
        ...
        // Plugin Options Page
        require_once $this->plugin_path . 'admin/class-options.php';
